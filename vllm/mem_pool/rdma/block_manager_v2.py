...
from vllm.mem_pool.rdma.cpu_gpu_block_allocator import CpuGpuBlockAllocator
...
class BlockSpaceManagerV2(BlockSpaceManager):
    ...
    def get_cached_blocks_delta(self, engine_id: int) -> Tuple[List[int], List[int]]:
        ...
        return self.block_allocator.get_cached_blocks_delta(engine_id)
