...
class PrefixCachingBlockAllocator(BlockAllocator):
    ...
    def __init__(
        ...
        self._cached_blocks_add_delta: List[List[PrefixHash]] = [[] for _ in range(num_engine)]
        self._cached_blocks_pop_delta: List[List[PrefixHash]] = [[] for _ in range(num_engine)]
    ...
    def get_cached_blocks_delta(self, engine_id: int) -> Tuple[List[int], List[int]]:
        ...
        self._cached_blocks_pop_delta[engine_id].clear()
